    ...
    <header className="sticky top-0 z-50 w-full bg-bleu-nuit/95 backdrop-blur-sm shadow-md">
      <div className="container mx-auto flex h-20 items-center justify-between px-4 md:px-6">
        ...
        <div className="flex items-center gap-4">
          <Button asChild className="hidden md:inline-flex bg-dore text-bleu-nuit hover:bg-dore/90">
          ...
          <Sheet>
            ...
            <SheetContent side="right" className="bg-bleu-nuit text-blanc border-l-dore">
              <nav className="grid gap-6 text-lg font-medium mt-8">
                ...
                <Button asChild className="mt-4 bg-dore text-bleu-nuit hover:bg-dore/90">
                  <Link href="/contact">Demander un Devis</Link>
                </Button>
              </nav>
            </SheetContent>
